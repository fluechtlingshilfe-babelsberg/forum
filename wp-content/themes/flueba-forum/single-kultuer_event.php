...
<div class="container post-about clearfix mb-1 mt-3">
    <ol class="breadcrumb">
  ...
  <p class="text-muted">
	...
	<?php if (!get_field('no_booking')) {?>
        <div class="card card-block col-sm-12 col-md-5 col-lg-4 mt-3 mb-1">
          <form action="<?= admin_url("admin-post.php") ?>" method="post">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <span class="input-group-addon">Karten</span>
              </div>
            </div>
            <div class="form-group">
